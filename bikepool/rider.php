...
<body>
  ...
  <section id="main">
    <div class="container">
      <article id="main-col">
        <br> <br>
        <h1 class="page-title"> FOR BIKE RIDERS : </h1><br>
        <ul id="services">
          <li>
...
if (isset($_POST['submited'])) {
  ...
  $imgerror = $img['error'];
         if($imgerror == 0){
           $destfile = 'uploads1/' .$imgname;
           //echo "$destfile" ;
           move_uploaded_file($imgpath , $destfile);
         }     
  $bike       = mysqli_real_escape_string($con, $_POST['bike']);
  $bikeno       = mysqli_real_escape_string($con, $_POST['bikeno']);
  ...
  $date  = mysqli_real_escape_string($con, $_POST['date']);
      ...
      $insertquery = "Insert into rider(name,img, bike, bikeno, conditions, fare, source, destination, date) values ('$name', '$destfile','$bike', '$bikeno', '$conditions','$fare', '$source', '$destination', '$date')";
      ...
      <aside id="sidebar">
        <div class="dark">
          ...
          <input type="file"  name="img"  class="find" required="required" />
             ...
             <br> <br>
             <input type="text" placeholder="Bike name" name="bike" class="find" required="required"/>
             <br> <br>
             <input type="text" placeholder="Bike no" name="bikeno" class="find" required="required"/>
             <br> <br>
             <input type="text" placeholder="Your Conditions for the Co-rider" name="conditions" class="find" required="required" />
             <br> <br>
             <input type="number" placeholder="Fare-₹" name="fare" class="find" required="required" />
             <br> <br>
  ...
  <div class="contain">
            <div class="footer-content">
                ...
                <div class="items">
                    ...
                    <li> <a href="corider.php">Post your ride</a></li>
                    <li> <a href="registration.php">register</a></li>
                    <li> <a href="login.php">login</a></li>
                    <li> <a href="about.php">About us</a></li>
                    <li> <a href="contact.php">contact us</a></li>
