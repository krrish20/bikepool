...
<?php
  ...
  if(!empty($email) && !empty($message)){
    if(filter_var($email, FILTER_VALIDATE_EMAIL)){
      $receiver = "amoghkrrish1067@gmail.com"; 
      $subject = "From: $email";
      $body = "topic: $name\nMessage:\n$message\n\nRegards,\n$name";
      $sender = "From: $email";
...
?>  
    ...
    <div class="field">
      ...
      <div class="dbl-field">
        <div class="field">
          YOUR MAIL : <input type="email" name="email" placeholder="Enter your email">
          <i class='fas fa-user'></i>
        </div>
      </div>
      <div class="message">
        YOUR MESSAGE : <textarea placeholder="Write your message" name="message"></textarea>
